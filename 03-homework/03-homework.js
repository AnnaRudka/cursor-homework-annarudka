...
document.querySelector(".btn2").addEventListener("click", (event) => {
  const number = +document.querySelector("#input02-number").value; // Отримаємо число і значення степеня від користувача
  const degree = +document.querySelector("#input02-degree").value;
  let result = 1;
  if (
    ...
    alert("Будь ласка введіть числа (степінь - ціле число)");
  } else {
...
document.querySelector(".btn6").addEventListener("click", (event) => {
  const word = document.querySelector("#input06-first").value; // Отримаємо дані від користувача
  const letter = document.querySelector("#input06-second").value;
...
document.querySelector(".btn7").addEventListener("click", (event) => {
  ...
  if (amount.includes("uah")) {
    ...
    alert("Будь ласка введіть суму у UAH або $");
  }
...
document.querySelector(".btn8").addEventListener("click", (event) => {
  const quantity = document.querySelector("#input08").value; // Отримаємо дані від користувача
  let password = "";
...
document.querySelector(".btn9").addEventListener("click", (event) => {
  const sentence = document.querySelector("#input09-first").value; // Отримаємо дані від користувача
  const letter = document.querySelector("#input09-second").value;
  let newSentence = sentence.replaceAll(letter, ""); // Робимо заміну символа на порожній рядок
...
document.querySelector(".btn10").addEventListener("click", (event) => {
...
document.querySelector(".btn11").addEventListener("click", (event) => {
